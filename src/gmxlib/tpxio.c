                        ...
                        int file_version, real *fudgeQQ)
{
    ...
    if(file_version>=39){
      ...
      if (bRead) {
        ...
        snew(ir->opts.nstates,     ir->opts.ngQM);
        snew(ir->opts.currstate,   ir->opts.ngQM);
      }
      if (ir->opts.ngQM > 0) {
        ...
        bDum=gmx_fio_ndo_int(fio,ir->opts.nstates,ir->opts.ngQM);
        bDum=gmx_fio_ndo_int(fio,ir->opts.currstate,ir->opts.ngQM);
      }
      /* end of QMMM stuff */
    }    
}
